...
- **Still open / verify on 2 devices:** answering possession + multi-round in live play; the OT-start freeze ("opponent has the ball, nothing happened") if the receiver's drive fails to spawn.
